...
public class FileUtils {
    ...
    public static String getFilePath(String extraPath,Context context) {

        if (!Environment.isExternalStorageRemovable()) {//如果外部储存可用
            File externalFilesDir = context.getExternalFilesDir(extraPath);
    ...
    public static void dealFile(Context context,String fileName,String extraPath) {
        String filePath = getFilePath(extraPath,context);
        if (filePath == null) {
            return;
        }
        //创建一个文件
