...
public class PickViewUtil {
    ...
    public static void showSelectPickDialog(final Activity context, List<ItemSelectModel> selectModel, int hierarchy, OptionPicker.OnOptionSelectListener optionSelectListener) {
